...
ApiBooksResponse apiBooksResponseFromJson(String str) => ApiBooksResponse.fromJson(json.decode(str));
String apiBooksResponseToJson(ApiBooksResponse data) => json.encode(data.toJson());
class ApiBooksResponse {
  ...
  ApiBooksResponse.fromJson(dynamic json) {
    _kind = json['kind'];
...
ApiBooksResponse copyWith({  String? kind,
  num? totalItems,
  List<Items>? items,
}) =>
    ApiBooksResponse(
